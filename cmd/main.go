...
import (
	...
	"github.com/unstoppablemango/minecraft-operator/internal/controller"
...
func init() {
	...
	utilruntime.Must(unmangodevv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "af09662e.unmango.dev",
	...
	if err = (&controller.MinecraftServerReconciler{
		...
		Recorder: mgr.GetEventRecorderFor("minecraftserver-controller"),
