...
type MinecraftServerSpec struct {
	...
	// Size defines the number of MinecraftServer instances
...
type MinecraftServerStatus struct {
	// Represents the observations of a MinecraftServer's current state.
	// MinecraftServer.status.conditions.type are: "Available", "Progressing", and "Degraded"
	// MinecraftServer.status.conditions.status are one of True, False, Unknown.
	// MinecraftServer.status.conditions.reason the value should be a CamelCase string and producers of specific
	// condition types may define expected values and meanings for this field, and whether the values
	// are considered a guaranteed API.
	// MinecraftServer.status.conditions.Message is a human readable message indicating details about the transition.
